...
function setupRhythmBlockPaletteBlocks() {
    ...
    class FifthNoteBlock extends FlowBlock {
        constructor() {
            super("fifthNote", _("fifth note") + " ♩");
            this.setPalette(rhythmBlockPalette);
            this.setHelpString();
            this.makeMacro((x, y) => [
                [0, "rhythm2", x, y, [null, 1, 2, 5]],
    ...
    class SeventhNoteBlock extends FlowBlock {
        constructor() {
            super("seventhNote", _("seventh note") + " ♩");
            this.setPalette(rhythmBlockPalette);
            this.setHelpString();
            this.makeMacro((x, y) => [
                [0, "rhythm2", x, y, [null, 1, 2, 5]],
    ...
    class Third1NoteBlock extends FlowBlock {
        constructor() {
            super("ThirdNote", _("Third note") + " ♩");
            this.setPalette(rhythmBlockPalette);
            this.setHelpString();
            this.makeMacro((x, y) => [
                [0, "rhythm2", x, y, [null, 1, 2, 5]],
    ...
    class HalfNoteBlock2 extends FlowBlock {
        constructor() {
            super("halfNote2");
            this.setPalette(rhythmBlockPalette);
            this.beginnerBlock(true);
    ...
    new HalfNoteBlock2().setup();
    new WholeNoteBlock().setup();
    new Tuplet2Block().setup();
    new FifthNoteBlock().setup();
    new Third1NoteBlock().setup();
    new SeventhNoteBlock().setup();
